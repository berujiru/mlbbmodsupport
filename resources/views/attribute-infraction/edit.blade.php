...
{!! Form::model($attribinfra, ['route' => ['attrib-infra.update', $attribinfra->attribute_infraction_id],'method' => 'PATCH']) !!}
<div class="row">
        ...
        <div class="form-floating">
            <select class="form-select" id="attribSelect" name="attribute_id">
                ...
                @foreach($list_attrib as $attrib)
                    <option value="{{$attrib->attribute_id}}" <?= $attrib->attribute_id == $attribinfra->attribute_id ? 'selected' : '' ?>>{{ $attrib->attribute_name }}</option>
                @endforeach
            </select>
        ...
        <div class="form-floating">
            <select class="form-select" id="infraSelect" name="infraction_id">
                ...
                @foreach($list_infra as $infra)
                    <option value="{{$infra->id}}" <?= $infra->id == $attribinfra->infraction_id ? 'selected' : '' ?>>{{ $infra->code }}</option>
                @endforeach
            </select>
