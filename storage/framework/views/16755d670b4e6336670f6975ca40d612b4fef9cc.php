...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h4>Edit Infraction to Attribute</h4>
        </div>
...
<?php echo Form::model($attribinfra, ['route' => ['attrib-infra.update', $attribinfra->attribute_infraction_id],'method' => 'PATCH']); ?>
        ...
        <div class="form-floating">
            <select class="form-select" id="attribSelect" name="attribute_id">
                ...
                <?php $__currentLoopData = $list_attrib; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attrib): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($attrib->attribute_id); ?>" <?= $attrib->attribute_id == $attribinfra->attribute_id ? 'selected' : '' ?>><?php echo e($attrib->attribute_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        ...
        <div class="form-floating">
            <select class="form-select" id="infraSelect" name="infraction_id">
                ...
                <?php $__currentLoopData = $list_infra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $infra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($infra->id); ?>" <?= $infra->id == $attribinfra->infraction_id ? 'selected' : '' ?>><?php echo e($infra->code); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/attribute-infraction/edit.blade.php ENDPATH**/ ?>