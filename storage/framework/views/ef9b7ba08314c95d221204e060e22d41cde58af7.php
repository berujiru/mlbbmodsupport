                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-first"><?php echo e($netreply->nte->MODID); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-end">Moderator Name : </td>
                                    <td class="text-first"><?php echo e(!empty($netreply->nte->profile) ? $netreply->nte->profile->firstname." ".$netreply->nte->profile->lastname : 'No profile found of '); ?></td>
                                </tr>
                                <tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mlbbmodsupport\resources\views/nte-reply-show.blade.php ENDPATH**/ ?>