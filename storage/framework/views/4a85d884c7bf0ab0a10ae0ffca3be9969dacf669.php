        ...
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
              ...
              <td style="width:10%;">
                ...
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('team-deputy.update-deputy',$dep->deputy_team_id)); ?>" title="Update Deputy"><i class="bx bx-fw bx-user-voice bx bx-xs"></i></a>
                <a class="btn btn-sm btn-danger" href="<?php echo e(route('team-deputy.delete',$dep->deputy_team_id)); ?>"><i class="bx bx-fw bx bx-trash"></i></a>
              </td>
          </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\mlbbmodsupport\resources\views/team-deputy/index.blade.php ENDPATH**/ ?>