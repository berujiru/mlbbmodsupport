                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel"
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item carousel-item-next carousel-item-start">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item active carousel-item-start">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>"
                                        alt="Third slide">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>"
                                        alt="Third slide">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/ui-carousel.blade.php ENDPATH**/ ?>