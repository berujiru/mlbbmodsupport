        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm">
                        <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail" class="text-dark">Noise
        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm">
                        <h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail" class="text-dark">350 ml
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/apps-ecommerce-cart.blade.php ENDPATH**/ ?>