...
<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('Assign User Type'); ?>  <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Assign User Type <?php $__env->endSlot(); ?>
...
<div class="row">
<?php echo Form::open(array('route' => 'assign-user-type.index','method'=>'GET')); ?>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="f_user_type" data-choices id="f_user_type">
                    ...
                    <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ut->user_type_id); ?>" <?= $ut->user_type_id == $f_user_type ? 'selected' : '' ?>><?php echo e($ut->user_type); ?></option>
  ...
  <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="mod_users" name="mod_users" data-choices multiple>
                                            <?php $__currentLoopData = $list_active_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $au): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($au->id); ?>"><?php echo e($au->modid.' - '.$au->firstname." ".$au->lastname); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
    ...
    <table class="table table-hover table-nowrap mb-0 align-middle">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $prof): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
        ...
        ?>
          <tr>
              ...
              <td style="width:20%;"><?php echo e($prof->modid); ?></td>
              <td style="width:20%;"><?= $fullname; ?></td>
              <td style="width:20%;"><?php echo e($prof->usertype->user_type); ?></td>
              <td style="width:15%;">
                <!-- <a class="btn btn-sm btn-primary" href="<?php echo e(route('user-type.assign-multiple',$prof->modid)); ?>" title="Update User Type"><i class="bx bx-fw bxs-user-detail bx bx-xs"></i></a> -->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" name="user_type<?= $prof->id ?>" id="user_type<?= $prof->id ?>">
                                                        <?php $__currentLoopData = $user_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($ut->user_type_id); ?>" <?= $prof->user_type_id == $ut->user_type_id ? 'selected' : '' ?>><?php echo e($ut->user_type); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    function assign_user_type_single(profiles){
        ...
        $.ajax({
            ...
            dataType: 'json',
            method: 'POST',
            data: {'profiles':profiles,'multiple':0,'user_type':user_type, _token: "<?php echo e(csrf_token()); ?>"},
            success: function (data) {
                var _icon_s = "";
                Swal.fire({
                    title: '',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/user-type/mods.blade.php ENDPATH**/ ?>