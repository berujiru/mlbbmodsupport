    ...
    <div class="card-header align-items-center d-flex">
      <h4 class="card-title mb-0 flex-grow-1">
        <div class="pull-right">
            <a class="btn btn-success" href="<?php echo e(route('attribute.create')); ?>"> <i class="bx bx-fw bx-book-add"></i>Add Attribute</a>
        </div>
      </h4>
    </div><!-- end card header -->
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $attrib): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
              ...
              <td style="width:20%;"><?php echo e($attrib->attribute_name); ?></td>
              <td style="width:30%;"><?php echo e(!empty($attrib->createdby) ? $attrib->createdby->firstname." ".$attrib->createdby->lastname : null); ?></td>
              <td style="width:10%;">
                <a class="btn btn-sm btn-info" href="<?php echo e(route('attribute.show',$attrib->attribute_id)); ?>" title="View Attribute"><i class="bx bx-fw bx-show bx-xs"></i></a>
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('attribute.edit',$attrib->attribute_id)); ?>" title="Edit Attribute"><i class="bx bx-fw bx-edit-alt bx-xs"></i></a>
                <a class="btn btn-sm btn-danger" href="<?php echo e(route('attribute.delete',$attrib->attribute_id)); ?>"><i class="bx bx-fw bx bx-trash"></i></a>
              </td>
          </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/attribute/index.blade.php ENDPATH**/ ?>