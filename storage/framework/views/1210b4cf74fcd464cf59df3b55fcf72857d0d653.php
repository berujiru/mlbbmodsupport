    ...
    <script>
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Success!</h4>' +
                '<p class="text-muted mx-4 mb-0"><?php echo e(Session::get("success")); ?></p>' +
                '</div>' +
                '</div>',
       ...
       Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<div class="mt-4 pt-2 fs-15">' +
                    ...
                    '<p class="text-muted mx-4 mb-0"><?php echo e(Session::get("error")); ?></p>' +
                '</div>' +
            '</div>',
            showCancelButton: true,
            showConfirmButton: false,
...
<?php /**PATH C:\xampp8\htdocs\mlbbmodsupport\resources\views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>