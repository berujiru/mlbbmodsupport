...
<?php $__env->slot('title'); ?> Credential  <?php $__env->endSlot(); ?>
<?php echo $__env->renderComponent(); ?>
<div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="<?php echo e(route('profileupdate')); ?>" autocomplete="off" class="form-horizontal">
            <?php echo csrf_field(); ?>
            ...
            <div class="card ">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-soft-success waves-effect waves-light"><?php echo e(__('Save')); ?></button>
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="col-md-12">
          <form method="post" action="<?php echo e(route('profile.password')); ?>" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-soft-success waves-effect waves-light"><?php echo e(__('Change password')); ?></button>
              </div>
            </div>
          </form>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/profile/edit.blade.php ENDPATH**/ ?>