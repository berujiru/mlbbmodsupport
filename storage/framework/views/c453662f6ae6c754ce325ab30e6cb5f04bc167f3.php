    ...
    <div class="email-content">
        <div class="p-4 pb-0">
            <div class="border-bottom border-bottom-dashed">
                ...
                <!-- start mail filter -->
                <?php echo Form::open(array('route' => 'mailbox','method'=>'GET')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/apps-mailbox.blade.php ENDPATH**/ ?>