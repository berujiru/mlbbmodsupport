...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class=" mb-4">
                                            <label for="input-password">Profile Picture <span
                                                    class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted"><script>document.write(new Date().getFullYear())</script> &copy; MLBBMODSUPPORT</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/auth/register.blade.php ENDPATH**/ ?>