                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-light fs-13">0</span>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $("#search-options").on('change', function (){
        ...
        $.ajax({ 
            url: 'search-profile',
            data: { matchvalue: matchvalue ,_token: "<?php echo e(csrf_token()); ?>"},
            type: 'post'
...
<?php /**PATH C:\xampp\htdocs\mlbbmodsupport\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>