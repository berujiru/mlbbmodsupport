    ...
    <div class="card-header align-items-center d-flex">
      <h4 class="card-title mb-0 flex-grow-1">
        <div class="pull-right">
            <a class="btn btn-success" href="<?php echo e(route('team-assignment.assign')); ?>"> <i class="bx bx-fw bx-book-add"></i>Assign Team</a>
        </div>
      </h4>
    </div><!-- end card header -->
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
              ...
              <td style="width:15%;">
                <a class="btn btn-sm btn-primary" href="<?php echo e(route('team.edit',$mod->team_id)); ?>" title="Edit Team"><i class="bx bx-fw bx-edit-alt bx-xs"></i></a>
                <a class="btn btn-sm btn-danger" href="<?php echo e(route('team.delete',$mod->team_id)); ?>" title="Remove Team"><i class="bx bx-fw bx bx-trash"></i></a>
              </td>
          </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/team/index-team-assign.blade.php ENDPATH**/ ?>