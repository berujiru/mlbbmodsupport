                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <h5 class="fs-14 mb-0">23 Nov, 2021 <small
                                    class="text-muted">02:36PM</small></h5>
                        </div>
                        <!--end col-->
                        <div class="col-lg-3 col-6">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted mb-1">Payment Method: <span
                                class="fw-medium">Mastercard</span></p>
                        <p class="text-muted mb-1">Card Holder: <span class="fw-medium">David
                                Nichols</span></p>
                        <p class="text-muted mb-1">Card Number: <span class="fw-medium">xxx xxxx xxxx
                                1234</span></p>
                        <p class="text-muted">Total Amount: <span class="fw-medium">$415.96</span></p>
                    </div>
                    <div class="mt-4">
                        <div class="alert alert-info">
                            <p class="mb-0"><span class="fw-semibold">NOTES:</span> All accounts are to
                                be paid within 7 days from receipt of invoice. To be paid by cheque or
                                credit card or direct payment online. If account is not paid within 7
                                days the credits details supplied as confirmation of work undertaken
                                will be charged the agreed quoted fee noted above.</p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp2\htdocs\mlbbmodsupport\resources\views/apps-invoices-details.blade.php ENDPATH**/ ?>